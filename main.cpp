...
class MyWidget : public QWidget
{
    void paintEvent(QPaintEvent *event){
        ...
        this->draw_line(pol, painter);
        this->draw_rect(rect, painter);
        this->draw_ellipse(el, painter);
        this->draw_arc(arc, painter);
        this->draw_polygon(poly, painter);
        this->draw_crooked_line(crook, painter);
        this->draw_text(text, painter);
        this->draw_image(image, painter);
        this->draw_transition_point(tr_p, painter);
        this->draw_transition_button(tr_b, painter);
        painter.end();
    }
    ...
    void draw_telemesure(FiguresClasses::Telemeasure &text, QPainter &painter){
        //начало отрисовки текста
        painter.save();
        QFont text_font(text.get_font_name().c_str(), text.get_font_size());
        text_font.setBold(text.get_bold_font());
