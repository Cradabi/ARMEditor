...
//
//    void
//    parseRectangle(Scheme::SchemeParams &scheme_params, const uint32_t block_size,
//                   int id_pos) {
//
//
...
//    }
//
//    void parseEllips(Scheme::SchemeParams &scheme_params, const uint32_t block_size,
//                     int id_pos) {
//
...
//    }
//
//    void parseText(Scheme::SchemeParams &scheme_params, const uint32_t block_size,
//                   int id_pos) {
//
//        uint32_t bytes_counter = 16;
//
...
//
//    void
//    parsePolygon(Scheme::SchemeParams &scheme_params, const uint32_t block_size,
//                 int id_pos) {
//        uint32_t bytes_counter = 16;
//
//        double center_x, center_y, angle;
...
//
//    void
//    parseTelecontrol(Scheme::SchemeParams &scheme_params, const uint32_t block_size,
//                     int id_pos) {
//
//        uint32_t bytes_counter = 16;
//
...
//
//    void
//    parseTelemeasure(Scheme::SchemeParams &scheme_params, const uint32_t block_size,
//                     int id_pos) {
//        uint32_t bytes_counter = 16;
//
//        double center_x, center_y, angle;
...
//
//    void
//    parseSignal(Scheme::SchemeParams &scheme_params, const uint32_t block_size,
//                int id_pos) {
//        uint32_t bytes_counter = 16;
//
//        double center_x, center_y, angle;
...
//
//    void
//    parsePicture(Scheme::SchemeParams &scheme_params, const uint32_t block_size, int id_pos,
...
//    }
//
//    void parseLine(Scheme::SchemeParams &scheme_params, const uint32_t block_size,
//                   int id_pos) {
//        uint32_t bytes_counter = 16;
//
//        double center_x, center_y, angle;
...
//    }
//
//    void parseArc(Scheme::SchemeParams &scheme_params, const uint32_t block_size,
//                  int id_pos) {
//        uint32_t bytes_counter = 16;
//
//        double center_x, center_y, angle;
...
//
//    void
//    parseGoBtn(Scheme::SchemeParams &scheme_params, const uint32_t block_size,
//               int id_pos) {
//        uint32_t bytes_counter = 16;
//
//        double center_x, center_y, angle;
...
//    }
//
//    void parseGoPoint(Scheme::SchemeParams &scheme_params, const uint32_t block_size,
//                      int id_pos) {
//        uint32_t bytes_counter = 16;
//
//        double center_x, center_y, angle;
