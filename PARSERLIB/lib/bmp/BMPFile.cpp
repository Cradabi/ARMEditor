...
public:
    void makeBmp(const std::string outputFile, std::vector<std::vector<ssp::BGRColor>> pixels) {
        ...
        std::ofstream bmp_fout("../PARSERLIB/tmp_pictures/" + outputFile + ".bmp", std::ios_base::binary);
